...
{
    // Create a class that is derived class of rclcpp::Node
    ...
    public:
        ...
        // FibonacciActionServer constructor initializes node name as "fibonacci_action_server"
            ...
            : Node("fibonacci_action_server", options)
        {
            ...
            // Constructor also instantiates a new action server
